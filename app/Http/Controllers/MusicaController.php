...
class MusicaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validateData = $request->validate([
                'titulo' => ['required', 'unique:musicas', 'string', 'max:100', 'filled'],
                'letra' =>['required', 'min:30'],
                'ano' =>['required', 'min:4', 'nullable', 'present', 'size:1000'],
                'album' =>['required', 'alpha_num', 'between:0,200', 'digits_between:0,200'],
                'premios' =>['required', 'numeric', 'integer', 'alpha_dash', 'digits:6'],
                'data'=>['required', 'date','after:tomorrow', 'before:2020-12-10', 'before_or_equal:2020-12-09']
            ]);
